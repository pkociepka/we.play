...
public class CustomPersistentRememberMeServices extends AbstractRememberMeServices {
    ...
    // PersistentToken is valid for one month
    ...
    @Inject
    public CustomPersistentRememberMeServices(Properties properties,UserDetailsService userDetailsService) {
    ...
    protected UserDetails processAutoLoginCookie(String[] cookieTokens, HttpServletRequest request,
        ...
        // PersistentToken also matches, so login is valid. Update the token value, keeping the *same* series number.
    ...
    private PersistentToken getPersistentToken(String[] cookieTokens) {
        ...
        if (!presentedToken.equals(token.getTokenValue())) {
            // PersistentToken doesn't match series value. Delete this session and throw an exception.
            persistentTokenRepository.delete(token);
